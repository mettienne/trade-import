    ...
    def format(self, line, city_zip=False):
        ...
        for k, vals in self.get_atts().iteritems():
            ...
            if city_zip and k == 'city_zip':
                obj[zip], obj[city] = parser.get_city(
                    line[
                        self.city_zip[0]], line[
                        self.key[0]], **rest)
                continue
            obj[k] = trans(line[v], line[self.key[0]], **rest)

        obj[update_key] = datetime.utcnow()
        # obj[.zip_code, self.city = parser.get_city(line[self.city_zip[0]],
        # line[self.key[0]])
        return obj
...
class Item(NaviObject):
    ...
    def __init__(self):
        ...
        self.price_1 = (16, parser.get_price)
        self.price_2 = (74, parser.get_price)
        self.price_3 = (75, parser.get_price)
        self.price_4 = (97, parser.get_price)
        self.price_5 = (98, parser.get_price)
...
class SalesInvoice(NaviObject):
    ...
    def __init__(self):
        ...
        self.created = (17, parser.get_date, {'log': False})
